...
2. 从 [Releases](https://github.com/tonyfenwick8814121/tokensaver/releases) 下载 `ClawNexus-TokenSaver-MCP-2026.6.1-testing.1.zip`。
3. 解压。
...
- Node.js：22.19+
- OpenClaw：建议 2026.5.12 到 2026.6.1
